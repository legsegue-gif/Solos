...
# ============================================================================
# PRoot Android Build Script (Solos fork)
# ============================================================================
# Cross-compiles a statically-linked libtalloc and the Solos/proot fork
...
#
# Repository: https://github.com/legsegue-gif/solos-proot (fork of termux/proot)
#
# Prerequisites:
...
build_proot() {
    if [ ! -d "$PROOT_DIR/src" ]; then
        log_error "PRoot source missing at $PROOT_DIR. Did you clone Solos/proot?"
    fi
