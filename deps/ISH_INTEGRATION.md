...
> **仓库**: [Solos/ish-arm64](https://github.com/legsegue-gif/solos-ish) (分支: `feature-arm64`)
...
创建 `SolosApp-Bridging-Header.h`:

```c
#ifndef SolosApp_Bridging_Header_h
#define SolosApp_Bridging_Header_h
...
```
$(PROJECT_DIR)/SolosApp-Bridging-Header.h
```
...
- [iSH-ARM64 仓库](https://github.com/legsegue-gif/solos-ish) (feature-arm64 分支)
