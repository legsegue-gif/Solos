...
static NSString *const HELP_TEXT =
    @"apple-vision - Image analysis using the Vision framework\n"
     ...
     "  Supports images in /var/solos/attachments/ and other accessible paths.\n"
     "\n"
     "EXAMPLES:\n"
     "  apple-vision ocr /var/solos/attachments/photo.jpg\n"
     "  apple-vision ocr /var/solos/attachments/doc.png --lang zh-Hans,en --level fast\n"
     "  apple-vision barcode /var/solos/attachments/qr.png --compact -q\n"
     "  apple-vision classify /var/solos/attachments/photo.jpg --limit 5\n"
     "  apple-vision analyze /var/solos/attachments/photo.jpg\n"
