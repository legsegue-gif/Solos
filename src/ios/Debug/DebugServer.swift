...
final class DebugServer: @unchecked Sendable {
    ...
    private func handleConnection(_ fd: Int32, peerIsLoopback: Bool) async {
        ...
        func schemaJSON() -> String {
            ...
            return """
            {"app":"SolosApp","version":"\(info["CFBundleShortVersionString"] as? String ?? "?")",\
