...
enum DebugMethodRegistry {
    ...
    static let methods: [MethodSpec] = [
        ...
        MethodSpec(
            ...
            description: "Build a .solosbak package (export only; unencrypted, stage 1).",
            params: [
                ...
                ParamSpec(name: "passphrase", type: "string", required: false, default: nil,
                          description: "Encrypt the package (solosbak-enc/1). REQUIRED when credentials are included."),
                ParamSpec(name: "deliver", type: "boolean", required: false, default: false,
                          description: "Move the package into Files-visible shared storage (Solos ▸ Backups), the path the Backup UI uses."),
            ],
        ...
        MethodSpec(
            ...
            description: "Import a .solosbak package (stage 2: Merge mode, unencrypted).",
            params: [
                ParamSpec(name: "path", type: "string", required: true, default: nil,
                          description: "Path to the .solosbak file"),
                ParamSpec(name: "categories", type: "array", required: false, default: nil,
            ...
            example: ["path": "/…/backup.solosbak"]
        ),
        MethodSpec(
            name: "debug.backup.cleanup",
            description: "Delete .solosbak packages left in Documents by export {keep:true}.",
            params: [],
        ...
        MethodSpec(
            ...
            description: "Salvage what can be read from a damaged .solosbak: rescue.json, manifest.json, its tail copy, and the surviving member list.",
            params: [
                ParamSpec(name: "path", type: "string", required: true, default: nil,
                          description: "Path to the (possibly damaged) .solosbak file"),
            ],
        ...
        MethodSpec(
            ...
            params: [
                ...
                ParamSpec(name: "deliver", type: "string", required: false, default: nil,
                          description: "Path to a .solosbak to copy to every destination"),
            ],
        ...
        MethodSpec(
            ...
            description: "Drive the 'opened a .solosbak from Files' entry point (BackupOpenRouter.handle) and report whether the root restore sheet would present.",
            params: [
                ParamSpec(name: "path", type: "string", required: true, default: nil,
                          description: "Path to the .solosbak file to open"),
            ],
            returns: "{recognisedAsPackage, handled, pendingPackage, hasPendingPackage, appIsLocked, sheetWouldPresent}",
            example: ["path": "/…/backup-20260814-0230.solosbak"]
        ),
        MethodSpec(
            name: "debug.backup.inspect",
            description: "List a .solosbak package's entries and read back its manifest.",
            params: [
                ParamSpec(name: "path", type: "string", required: true, default: nil,
                          description: "Path to the .solosbak file"),
            ],
        ...
        MethodSpec(
            name: "debug.db.list",
            description: "List the app's known SQLite databases (solos, skills, provider-config, voice-correction, alarm-labels, rootfs-meta) with existence and size.",
            params: [],
        ...
        MethodSpec(
            ...
            example: ["name": "solos", "table": "messages"]
        ),
        MethodSpec(
            name: "debug.db.query",
            ...
            example: ["name": "solos", "sql": "SELECT role, COUNT(*) c FROM messages GROUP BY role", "limit": 20]
        ),
        MethodSpec(
        ...
        MethodSpec(
            ...
            description: "Toggle whether a model entry is exposed to the in-shell `solos-model-use` agent.",
            params: [
                ParamSpec(name: "entryId", type: "string", required: true, default: nil, description: "Target entry UUID."),
        ...
        // MARK: solos-config (remote CLI driver)
        MethodSpec(
            name: "config.get",
            description: "Read one solos-config path through the real ConfigOffloadBridge — identical to `solos-config get <path>` in the iSH guest. Works for flat fields, collection children (`<base>.<id>.<leaf>`) and read-only aggregates.",
            params: [
        ...
        MethodSpec(
            name: "config.set",
            description: "Write solos-config path(s) through the real write batch — the same code path as `solos-config set`, including collection add/remove (`<base>.add` / `<base>.remove`) and array append. By DEFAULT this triggers the on-device confirmation sheet and blocks until it is answered (120s gate timeout); pass skipConfirmation to bypass it for unattended runs.",
            params: [
        ...
        MethodSpec(
            name: "config.topics",
            description: "Every registered solos-config topic — the index `solos-config --help` prints. Use it to confirm a collection is actually registered.",
            params: [],
        ...
        MethodSpec(
            ...
            description: "Field schema for one topic, as `solos-config <topic> --help` prints it. This is how the writable paths of a collection are discovered.",
            params: [
        ...
        MethodSpec(
            name: "config.audit",
            description: "Recent solos-config audit rows, to prove a write was recorded with the expected actor/status rather than merely returning ok.",
            params: [
        ...
        MethodSpec(
            ...
            description: "Toggle whether a group is exposed to the in-shell solos-model-use agent.",
            params: [
                ParamSpec(name: "groupId", type: "string", required: true, default: nil, description: "Target group UUID."),
        ...
        MethodSpec(
            ...
            description: "Run Quick Test on a specific model entry (same as the UI Quick Test sheet). Tests applicable modalities (text, speechOut, transcription, imageGen) concurrently and returns results. Use `solos-config get models` to find entry IDs.",
            params: [
                ParamSpec(name: "entryId", type: "string", required: true, default: nil, description: "The model entry ID to test (from `solos-config get models`)."),
