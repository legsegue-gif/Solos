...
class RootfsManager {
    ...
    /// [T-mcp-cli-help-and-readonly-ios] Guest path of the bundled solos-mcp-cli
    /// Python lib. Its files are mounted read-only (see applyDefaultMountOverlay).
    private static let mcpCliLibDir = "/usr/local/lib/solos-mcp-cli"
    private static let mcpCliLibPrefix = "/usr/local/lib/solos-mcp-cli/"
    ...
    func installIfNeeded() throws {
        ...
        // Pre-create /var/solos/ shared directory structure
        let solosSubdirs = ["var/solos/attachments", "var/solos/offloads", "var/solos/workspace", "var/solos/skills", "var/solos/shared"]
    ...
    func applyDefaultMountOverlay() {
        ...
        while let fileURL = enumerator.nextObject() as? URL {
            ...
            do {
                ...
                // like /usr/local/bin/solos-open are always executable.
                ...
                // [T-mcp-cli-help-and-readonly-ios] The bundled solos-mcp-cli
        ...
        // solos-mcp-cli lib FILES read-only (0o444), but ensureParentDirsInMetaDB
