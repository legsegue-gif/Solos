...
final class GeminiOAuthManager: NSObject, ObservableObject {
    ...
    static let legacyKeychainService = "com.solos.app.gemini-oauth"
    static let legacyKeychainAccount = "token"
    static let legacyEmailKey = "com.solos.app.gemini-email"
    static let legacyProjectIDKey = "com.solos.app.gemini-gcp-project"
