...
struct ProviderInstance: Identifiable, Codable, Hashable {
    ...
    /// Solos default UA. Set for proxy/relay endpoints that gate on client UA (only
    ...
    func computeHasAnyCredential() -> Bool {
        ...
        // Mirrors the diagnostic in SolosApp.swift scenePhase=active.
        switch providerType {
        case .anthropic:
