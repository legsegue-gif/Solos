...
enum OpenRouterModelsAPI {
    ...
    static func fetchModels(apiKey: String, forceRefresh: Bool = false) async throws -> [LLMModel] {
        ...
        request.setValue("https://github.com/legsegue-gif/Solos", forHTTPHeaderField: "HTTP-Referer")
        request.setValue("Solos App", forHTTPHeaderField: "X-Title")
...
private enum OpenRouterModelsCache {
    ...
    private static var cacheDir: URL {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask)[0]
            .appendingPathComponent("com.solos.app.openrouter-models-cache", isDirectory: true)
    }
