...
enum ModelsDevAPI {
    ...
    private static func applyDevData(
        ...
        // [Solos#163] Carry the affirmative "no effort tiers" answer too.
    ...
    private static var cacheFileURL: URL {
        ...
        return caches.appendingPathComponent("com.solos.app.models-dev-cache").appendingPathComponent("api.json")
    }
...
private struct ModelsDevModel: Decodable {
    ...
    /// [Solos#163] True when the catalog AFFIRMATIVELY says this model has
