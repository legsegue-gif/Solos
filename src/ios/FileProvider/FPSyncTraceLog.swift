...
/// via `debug.readFile path:"AppGroup/SolosConfig/fp-sync-trace.log"`.
///
...
enum FPSyncTraceLog {
    ...
    private static let queue = DispatchQueue(label: "com.solos.app.FileProvider.fpSyncTrace")
    private static let osLog = OSLog(subsystem: "com.solos.app.FileProvider", category: "FPSyncTrace")
