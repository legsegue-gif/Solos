...
/// Watches the App Group `SolosFileProvider/{shared,skills,memory}/` subtrees and
...
final class AppGroupChangeWatcher {
    ...
    private let queue = DispatchQueue(label: "com.solos.app.fpwatcher", qos: .utility)
    private let domainIdentifier = NSFileProviderDomainIdentifier("com.solos.app.files")
