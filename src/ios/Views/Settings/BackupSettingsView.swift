...
struct BackupSettingsView: View {
    ...
    var body: some View {
            ...
            if let result {
                Section {
                    ...
                    if localCopyRemoved {
                        ...
                        Text("Saved in Solos ▸ Backups. Use Save to Files to copy it to iCloud Drive, a connected server, or another cloud provider.")
                    } else {
                        ...
                        Text("Saved in Solos ▸ Backups, and copied to \(ok) of \(deliveryResults.count) selected folder(s).")
                    }
                }
            }
        }
        ...
        // mounted at the WindowGroup root (SolosApp.swift) so opening a
        // .solosbak from Files works from ANY screen — this view is the one
    ...
    /// mounted in Files and authorised in Solos is just a directory, and
