...
private struct MemoryFileEditView: View {
    ...
    private var fileURL: URL {
        AIChatViewModel.solosMemoryPersistentDir.appendingPathComponent(fileName)
    }
    ...
    private func save() {
        let fm = FileManager.default
        try? fm.createDirectory(at: AIChatViewModel.solosMemoryPersistentDir, withIntermediateDirectories: true)
        do {
            ...
            SolosToast.show(AppLocalized("Saved"))
...
extension Notification.Name {
    ...
    static let memoryFilesDidChange = Notification.Name("com.solos.app.memoryFilesDidChange")
}
