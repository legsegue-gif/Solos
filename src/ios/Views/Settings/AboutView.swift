        ...
        List {
            ...
            Section {
                VStack(spacing: 8) {
                    ...
                    Text("Solos is Your Fully Local, Fully Private On-Device Agent.")
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
                    // GPL-3.0 §5(a) 要求的修改声明，与 Android 端同源。
                    // 刻意不走 l10n：法定声明不接受译文改写。逐字保留。
                    Text("Based on OpenMinis (GPL-3.0), modified 2026")
                        .font(.caption2)
                        .foregroundStyle(.tertiary)
                }
            ...
            // MARK: - Links
            Section("Links") {
                Link(destination: URL(string: "https://github.com/legsegue-gif")!) {
                    Label {
                        HStack {
                ...
                Link(destination: URL(string: "https://github.com/legsegue-gif/Solos/issues")!) {
                    Label {
                        HStack {
