...
/// Settings page for SOUL.md — Solos's persistent personality file.
...
private struct SoulIconEditing: ViewModifier {
    ...
    private func applyPickedImage(_ item: PhotosPickerItem) async {
        ...
        // `solos-config` path apply exactly the same rule.
