...
struct AssistantBlockView: View {
    ...
    /// [T-selection-menu-solos-tts] Selection-menu read-aloud hooks, plumbed
    ...
    var body: some View {
        ...
        .alert(
            ...
            Button(AppLocalized("Go Enable")) {
                ...
                // (= solos://settings/background?focus=…:true,…:true). Location
...
extension Notification.Name {
    ...
    static let solosAttachmentSizeChanged = Notification.Name("solosAttachmentSizeChanged")
