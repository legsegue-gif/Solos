...
/// stack (NSTextStorage + SolosLayoutManager + NSTextContainer).
///
...
final class MarkdownRenderView: UIView, UIGestureRecognizerDelegate {
    ...
    let textLayoutManager: SolosLayoutManager
    ...
    override init(frame: CGRect) {
        ...
        textLayoutManager = SolosLayoutManager()
    ...
    /// TextKit-1 `SolosLayoutManager`, so the computation is identical; nil
