//
//  SolosShareSheet.swift
//  SolosApp
//
//  UIKit UIActivityViewController wrapper used throughout the chat UI
//  to share solos:// files, images, audio, video, links, and previews.
...
struct SolosShareSheet: UIViewControllerRepresentable {
    let url: URL
    ...
    /// (`Solos-2026-05-18-205557.ips`): `SHKItemIsPDF` →
    ...
    /// other schemes (solos://, file:// with no path, etc.) return
