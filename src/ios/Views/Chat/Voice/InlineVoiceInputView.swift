...
struct InlineVoiceInputView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: Notification.Name("SolosDebugVoiceMicTap"))) { _ in
    ...
    private var expandedBody: some View {
        VStack(spacing: Self.expandedStackSpacing) {
            ...
            // SolosToast instead of an inline pill here — the pill inserted a
    ...
    private var correctionButton: some View {
        ...
        .alert(AppLocalized("Improve voice corrections?",
            ...
            Text("Solos can store your transcript fixes (original → corrected pairs) and accepted AI corrections in a local on-device database to make future voice corrections smarter. Nothing is uploaded. You can change this or clear the data anytime in Settings → Permissions.",
            ...
            await MainActor.run {
                ...
                if suggestion.hasChange {
                    ...
                    if reason == "llm_timeout" || reason.hasPrefix("llm_error") {
                        ...
                        SolosToast.show(AppLocalized("Correction failed, original kept",
                        ...
                        SolosToast.show(AppLocalized("No corrections needed",
