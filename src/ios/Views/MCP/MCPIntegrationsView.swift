...
struct MCPIntegrationsView: View {
    /// [T-mcp-oauth-deeplink] When set (solos://settings/mcp-servers/<id>),
    ...
    var body: some View {
        ...
        // server written by solos-mcp-cli after launch shows up without an app
...
/// refresh (`solos-mcp-cli refresh <name>`: evict the daemon session,
