...
///   2. Build an `https://solos.example/launch.html?…` URL whose query
...
///      to `solos://open?session=…&path=…`, which `DeepLinkRouter` routes
...
///   - a PNG at solos.app/icons/category/<rawValue>.png
