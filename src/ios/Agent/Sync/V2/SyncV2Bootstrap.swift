...
/// from SolosApp.swift. Wires Syncable types into the registry, registers
...
enum SyncV2Bootstrap {
    ...
    static func setEnabled(_ enabled: Bool) {
        ...
        // builds required a relaunch because boot only ran from SolosApp
    ...
    /// Called once from SolosApp launch (or on flag flip in debug builds).
    ...
    static func startIfEnabled() async {
        ...
        Task { @MainActor in
            ...
            do {
                ...
                // Self-register this device into solos-devices zone so peers
