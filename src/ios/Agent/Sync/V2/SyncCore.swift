...
final class SyncCore {
    ...
    private func startPathMonitor() {
        ...
        m.start(queue: DispatchQueue(label: "com.solos.sync.pathMonitor"))
        pathMonitor = m
    }
    ...
    func sendNow(trigger: SyncSendTrigger) async {
        ...
        // change tracker (shell tools writing under /var/solos/<subdir>)
    ...
    /// truncate, unlink, rename inside `/var/solos/<workspace|attachments|browser|offloads>/...`)
