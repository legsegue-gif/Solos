        ...
        var tools: [AgentToolDefinition] = [
            ...
            AgentToolDefinition(
                ...
                parameters: [
                    ...
                    "path": AgentToolParam(type: .string, description: "Absolute Linux path to read (e.g. /var/solos/workspace/data.csv)"),
        ...
        if nativeVision || visionGroupConfigured {
            ...
            tools.append(AgentToolDefinition(
                ...
                parameters: [
                    ...
                    "path": AgentToolParam(type: .string, description: "Linux path (e.g. /var/solos/attachments/chart.png) or solos:// URL (e.g. solos://attachments/chart.png)"),
