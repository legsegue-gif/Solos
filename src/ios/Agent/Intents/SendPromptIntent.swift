...
/// Sends a prompt to the Solos AI agent and returns immediately with structured session info.
...
struct SendPromptIntent: AppIntent {
    ...
    static var description = IntentDescription("Sends a prompt to the Solos AI agent. Returns session info immediately while the task runs in the background.")
    ...
    @Parameter(title: "Prompt",
               requestValueDialog: "What would you like to ask Solos?",
    ...
    func perform() async throws -> some IntentResult & ReturnsValue<SendPromptResult> & ProvidesDialog {
        ...
        if sendCompletionNotification {
            ...
            ShortcutNotification.post(
                ...
                title: AppLocalized("Solos Task Started"),
        ...
        if waitForResult {
            ...
            if sendCompletionNotification {
                ShortcutNotification.post(
                    ...
                    title: AppLocalized("Solos Task Completed"),
