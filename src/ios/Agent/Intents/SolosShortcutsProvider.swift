...
/// Siri trigger phrases (zh-Hans/zh-Hant, e.g. "问问Solos") live in
...
@available(iOS 17.0, *)
struct SolosShortcutsProvider: AppShortcutsProvider {
    static var appShortcuts: [AppShortcut] {
        // Siri-facing "ask Solos" entry — opens the app and lands in the
