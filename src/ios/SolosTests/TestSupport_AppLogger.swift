...
//
// The SolosTests target compiles a few production sources directly (ContextPolicy,
...
// SolosTests synchronized folder, so it is compiled ONLY into the test bundle and
