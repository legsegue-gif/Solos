...
///     level, including ids that also match a family pattern (Solos#226). The
...
final class ThinkingWireGeminiAnthropicSnapshotTests: XCTestCase {
    ...
    private let geminiModels = [
        ...
        // [Solos#226] Specialized ids that ALSO match a family pattern — the exact
    ...
    func testGemini37FlashSpecializedSuffixStillSendsNothing() {
        // The -tts/-image/-embedding/-vision precedence (Solos#226) must
