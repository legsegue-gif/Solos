...
final class ThinkingRulesRegressionTests: XCTestCase {
    ...
    /// evidence §A "[Mistral] 完全禁止一切 reasoning 字段" · 4592ca9b · Solos#87.
    ///
    ...
    /// body.reasoning` of Solos#87. The gate now sits at the top of that block.
    ///
    ...
    /// branch still emitted the key). evidence §A · 84f5c9e1 · Solos#86.
