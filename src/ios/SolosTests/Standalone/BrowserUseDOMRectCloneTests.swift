...
//
// Standalone (`swift BrowserUseDOMRectCloneTests.swift`) because the SolosTests
...
let sourcePath: String = {
    // …/src/ios/SolosTests/Standalone/thisfile.swift → …/src/ios/Agent/BrowserUse/…
    let here = URL(fileURLWithPath: #filePath)
    return here.deletingLastPathComponent()      // Standalone
        .deletingLastPathComponent()             // SolosTests
