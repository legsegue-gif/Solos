...
///
/// Without an explicit header, URLSession sends `Solos/<CFBundleVersion>
/// CFNetwork/… Darwin/…` — i.e. the **build number** (e.g. `Solos/1`), not the
...
/// e.g. `Solos/1.10 (iOS 26.5; iPhone)`.
///
...
enum SolosUserAgent {
    ...
    static var `default`: String {
        ...
        let ua = "Solos/\(version) (iOS \(osVersion); \(model))"
        cached = ua
        return ua
    }
}
