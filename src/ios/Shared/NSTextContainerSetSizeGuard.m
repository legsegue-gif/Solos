...
static void solos_NSTextContainer_setSize(id self, SEL _cmd, CGSize newSize) {
    ...
    // occasionally leaks through (observed in Solos-2026-05-22-225827.ips
...
+ (void)install {
    ...
    dispatch_once(&once, ^{
        ...
        gOriginalSetSize = method_setImplementation(m, (IMP)solos_NSTextContainer_setSize);
