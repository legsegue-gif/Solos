...
enum AudioTogglePlaybackBridge {
    ...
    static let darwinNotificationName = "com.solos.app.liveActivity.audioToggle"
}
...
struct AudioTogglePlaybackIntent: LiveActivityIntent {
    ...
    static var description = IntentDescription("Toggles play/pause on Solos audio narration from the Live Activity.")
