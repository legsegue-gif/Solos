...
fun SolosMenu(
    ...
    // [T-android-solos-menu-ios26-anim] BOTH branches (default left-anchored and
    // alignEnd right-anchored) now render through ONE custom Popup +
    // AnimatedVisibility so every SolosMenu gets the same iOS 26-style
    ...
    Popup(
        ...
        AnimatedVisibility(
            ...
            Surface(
                // [T-android-solos-menu-width] Size to the CONTENT's intrinsic
...
/**
 * Subtle inset divider for grouping items inside a [SolosMenu]. T289:
 ...
 */
@Composable
fun SolosMenuDivider(modifier: Modifier = Modifier) {
