...
import com.solos.app.provider.voice.VoiceInputRequest
import com.solos.app.provider.voice.VoiceProvider
import com.solos.app.provider.voice.VoiceProviderException
import com.solos.app.provider.voice.VoiceProviderFactory
...
class ProviderSpeechRecognitionEngine(private val appContext: Context) : SpeechRecognitionEngine {
    ...
    private fun repository() =
        (appContext.applicationContext as? SolosApp)
    ...
    private fun startVadCapture(
        locale: Locale,
        repo: com.solos.app.data.repository.ProviderRepository,
        candidates: List<Pair<com.solos.app.data.model.ProviderInstance, com.solos.app.data.model.ModelEntry>>,
