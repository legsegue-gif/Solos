...
import com.solos.app.offload.ShizukuBackend
 ...
 *                        installed manager.
 *   NEED_PERMISSION   → "Authorize Solos" CTA → triggers system dialog.
        ...
        SettingsSection(
            ...
            SettingsRow(
                ...
                subtitle = if (snap.state == ShizukuManager.State.READY) {
                    ...
                    // user can see their root module is what's serving Solos.
                    if (snap.isSui) {
