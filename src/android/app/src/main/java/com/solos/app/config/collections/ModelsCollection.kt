...
class ModelsCollection(
    ...
    override fun add(payload: ConfigValue): String {
        ...
        // (CLI-facing alias documented in `solos-config` help). Either
    ...
    /**
     * Canonical names matching `solos-model-use list` so the two tools
    ...
    private fun effectiveModalities(e: ModelEntry): List<String> {
        ...
        // direction-suffixed names that match `solos-model-use list`.
