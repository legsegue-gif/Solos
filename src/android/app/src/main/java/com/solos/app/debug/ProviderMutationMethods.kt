...
internal object ProviderMutationMethods {
    ...
    private fun repo(context: Context): ProviderRepository =
        (context.applicationContext as? SolosApp
            ?: throw RPCException(-32000, "SolosApp not initialized")).providerRepository
    ...
    fun instancesUpdate(context: Context, params: JSONObject): JSONObject {
        ...
        // solos-config writer guard in ProvidersCollection.kt.
