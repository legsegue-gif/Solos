package com.solos.app.speech.correction
...
object CorrectionAdmission {
    ...
    object Config {
         ...
         * admits linux↔solos (skeletons lnx/mns, sim 0.33) while rejecting
    ...
    sealed class Verdict {
        ...
        /** Latin near-sound (consonant-skeleton match) — e.g. linux→solos. */
    ...
    fun judge(
        ...
        // Signal 4 — Latin near-sound (linux→solos). Levenshtein over the full
     ...
     * throws away order, and linux/solos (l,n,x vs m,n,s) then scores exactly
     ...
     * positive: linux↔ninja, indistinguishable from linux↔solos on every
