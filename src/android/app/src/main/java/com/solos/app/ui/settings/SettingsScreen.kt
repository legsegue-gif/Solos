...
import com.solos.app.ui.components.openExternalUrl
        ...
        Column(
            ...
            SettingsSection(title = stringResource(R.string.settings_section_about)) {
                SettingsItem(
                    ...
                    iconColor = Color(0xFF007AFF),
                    title = stringResource(R.string.settings_about_solos),
                ...
                SettingsItem(
                    ...
                    onClick = { openExternalUrl(context, "https://legsegue-gif.github.io/solos-privacy.html") },
                )
                SettingsItem(
 ...
 *
 * URL shape:
 *   https://github.com/legsegue-gif/Solos/issues/new
...
private fun buildBugReportUrl(): String {
    ...
    val body = """
        ...
        | Solos Version | $versionName (build $versionCode) |
    ...
    return "https://github.com/legsegue-gif/Solos/issues/new" +
        "?template=bug_report.md" +
        "&title=$title" +
        "&body=$encodedBody"
}
...
private fun buildFeedbackMailto(): String {
    ...
    """.trimIndent()
    val subject = java.net.URLEncoder.encode("Solos Feedback", "UTF-8")
    val encodedBody = java.net.URLEncoder.encode(body, "UTF-8")
    return "mailto:dev@solos.app?subject=$subject&body=$encodedBody"
}
