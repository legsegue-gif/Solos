 ...
 * GH Solos#22 be fixed on the OpenAI path while #70 stayed broken on the Anthropic path.
 */
data class ReasoningEchoPolicy(
    /**
     * `reasoning_content` / `reasoning` / `reasoning_text` — the three spellings observed
     * in the wild, sometimes three different ones on one gateway (GH Solos#171).
     */
