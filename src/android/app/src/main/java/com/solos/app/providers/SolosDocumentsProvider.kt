package com.solos.app.providers
...
/**
 * Exposes `<filesDir>/solos-global/{memory,skills,shared}` to the system
 ...
 * ```xml
 * <provider android:name=".providers.SolosDocumentsProvider"
 *     android:authorities="com.solos.solos.documents"
 ...
 * Files app.
 */
class SolosDocumentsProvider : DocumentsProvider() {

    companion object {
        const val AUTHORITY = "com.solos.solos.documents"
        private const val ROOT_ID = "solos-root"
    ...
    private fun providerRoot(): File {
        ...
        return File(ctx.filesDir, "solos-global").apply { mkdirs() }
    }
    ...
    override fun queryDocument(documentId: String, projection: Array<String>?): Cursor {
        ...
        val displayName = if (documentId.isEmpty()) "Solos" else file.name
        cursor.newRow()
