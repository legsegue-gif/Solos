...
/**
 * One configurable setting. Concrete kinds: [com.solos.app.config.fields.PrefsBoolField]
 * etc. for SharedPreferences-backed scalars; [com.solos.app.config.fields.ClosureField]
...
interface ConfigField {
     ...
     * already blocks these entries, and solos-config must not be a side door
     * around that gate.
     *
