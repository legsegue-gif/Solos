...
fun EnvironmentVariablesScreen(
    ...
    val privacyEnabled by com.solos.app.data.EnvVarPrivacyStore.enabled.collectAsState()
    ...
    SettingsScaffold(
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = { com.solos.app.data.EnvVarPrivacyStore.setEnabled(it) },
                showDivider = false,
            )
        }
    ...
    if (deleteEntryId != null) {
        ...
        AlertDialog(
            ...
            dismissButton = {
                SolosTextButton(onClick = { deleteEntryId = null }) {
