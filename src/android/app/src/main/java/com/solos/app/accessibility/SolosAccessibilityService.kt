...
/**
 * SolosAccessibilityService — host-side AccessibilityService backing the
 ...
 */
class SolosAccessibilityService : AccessibilityService() {

    companion object {
        private const val TAG = "SolosA11y"
        const val SERVICE_ID = "com.solos.app/.accessibility.SolosAccessibilityService"
        private const val EVENT_RING_CAP = 1024

        @Volatile
        private var _instance: SolosAccessibilityService? = null

        fun getInstance(): SolosAccessibilityService? = _instance
    }
