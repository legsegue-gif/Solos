 ...
 * [com.solos.app.logging.AppLogger.listLogFiles] already filters
...
class CrashFileSender : ReportSender {
    ...
    override fun send(context: Context, errorContent: CrashReportData) {
        ...
        val body = buildString {
            appendLine("=== Solos Java/Kotlin Crash ===")
    ...
    companion object {
        ...
        // alongside the daily solos-YYYY-MM-DD.log files (which AppLogger
