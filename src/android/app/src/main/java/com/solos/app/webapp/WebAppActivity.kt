...
import com.solos.app.MainActivity
...
class WebAppActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            val app = applicationContext as SolosApp
     ...
     * screen offering an "Open in Solos" escape hatch.
     */
                    ...
                    Box(
                        ...
                        Card(modifier = Modifier.padding(24.dp)) {
                            Column(
                                ...
                                SolosButton(onClick = { openInSolos(sourceSessionId) }) {
                                    Text(stringResource(R.string.webapp_open_in_solos))
                                }
                            }
                        }
                    }
    ...
    private fun openInSolos(sourceSessionId: String?) {
    ...
    companion object {
        ...
        const val ACTION_OPEN_WEBAPP = "com.solos.app.action.OPEN_WEBAPP"
