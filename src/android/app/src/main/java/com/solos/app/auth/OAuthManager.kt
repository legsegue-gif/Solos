...
abstract class OAuthManager(
    ...
    companion object {
        ...
        fun hasStoredCredential(context: Context, instanceId: String): Boolean {
            val prefs = com.solos.app.util.EncryptedPrefsFactory
        ...
        fun forInstance(context: Context, instance: com.solos.app.data.model.ProviderInstance): OAuthManager? {
            return when (instance.providerType) {
                com.solos.app.data.model.ProviderType.anthropic -> ClaudeOAuthManager(context, instance.id)
                com.solos.app.data.model.ProviderType.openAI -> OpenAIOAuthManager(context, instance.id)
                com.solos.app.data.model.ProviderType.xAI -> XAIOAuthManager(context, instance.id)
                com.solos.app.data.model.ProviderType.kimiCode -> KimiOAuthManager(context, instance.id)
                else -> null
            }
        }
    }
    ...
    private fun getEncryptedPrefs() =
        com.solos.app.util.EncryptedPrefsFactory.safeCreate(context, "oauth_prefs")
