                ...
                r = OffloadPermissionManager.requestSettingsGate(
                    OffloadPermissionManager.SettingsGateRequest(
                        ...
                        message = if (needsWrite) {
                            "Solos needs read + write contacts permission to delete entries. Open Settings to allow it."
                        } else {
                            "Solos needs contacts permission to read your address book. Open Settings to allow it."
                        },
