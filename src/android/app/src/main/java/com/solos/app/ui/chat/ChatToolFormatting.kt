...
// Helper: tool display name for "Solos is using X"
...
/**
 * Full "Solos is …" label shown in the tool detail sheet's bottom bar.
...
internal fun toolTitleLabel(toolName: String): String = when (toolName) {
    ...
    else -> "Solos is using ${toolDisplayName(toolName)}"
}
