...
import com.solos.app.data.db.ChatDao
...
import com.solos.app.data.model.ModelAttributionSnapshot
...
class ChatRepository(internal val dao: ChatDao) {
     ...
     * from [com.solos.app.data.model.ContentPart]: "toolUse" / "toolResult"
     ...
     * [com.solos.app.ui.chat.ChatViewModel.rerunFromToolBlock]'s block-
    ...
    // ───────────────── T188: solos-sessions-cli backend ─────────────────
    //
    ...
    /**
     * Backs `solos-sessions-cli list`. Returns sessions ordered by
    ...
    /**
     * Backs `solos-sessions-cli search`. Over-fetches `limit * 3` rows
    ...
    /**
     * Backs `solos-sessions-cli messages --id ... --offset --limit`.
    ...
    suspend fun loadMessagePage(
        ...
        // documented 600; `solos-sessions-cli messages --full` passes
    ...
    /**
     * Paginated raw [MessageEntity] page — used by [com.solos.app.share.ChatExporter]
...
/** T188: shape of a session row surfaced to `solos-sessions-cli list`. */
...
/** T188: a single matching message returned by `solos-sessions-cli search`. */
