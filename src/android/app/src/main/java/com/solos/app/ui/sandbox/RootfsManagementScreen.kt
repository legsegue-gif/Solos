...
import com.solos.app.ui.components.SettingsRowDivider
import com.solos.app.ui.components.SettingsSection
...
fun RootfsManagementScreen(
    ...
    if (showResetDialog) {
        AlertDialog(
            ...
            dismissButton = {
                SolosTextButton(onClick = { showResetDialog = false }) {
    ...
    if (showResetBackupDialog) {
        AlertDialog(
            ...
            dismissButton = {
                SolosTextButton(onClick = { showResetBackupDialog = false }) {
                    Text(stringResource(R.string.common_cancel))
                }
            },
        )
