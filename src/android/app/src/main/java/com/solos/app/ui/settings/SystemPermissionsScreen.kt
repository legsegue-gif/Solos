...
import com.solos.app.power.PowerOptimizationManager
...
fun SystemPermissionsScreen(onBack: () -> Unit) {
    ...
    LaunchedEffect(Unit) {
        while (true) {
            ...
            val connected = SolosAccessibilityService.getInstance() != null
    ...
    Scaffold(
        ...
        Column(
            ...
            if (a11yRestricted) {
                SettingsSection(
                    ...
                    SettingsRow(
                        ...
                        // Lands on Solos' own App info page, where the
            ...
            var correctionEnabled by remember {
                mutableStateOf(
                    com.solos.app.speech.correction.VoiceCorrectionConsent.isEnabled(context),
                )
            }
            ...
            if (showClearCorrectionConfirm) {
                AlertDialog(
                    ...
                    dismissButton = {
                        SolosTextButton(onClick = { showClearCorrectionConfirm = false }) {
