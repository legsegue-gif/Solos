...
import com.solos.app.provider.thinking.ThinkingWireFormat
    ...
    AlertDialog(
        ...
        text = {
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                ...
                Column {
                    SolosTextButton(onClick = { formatMenuOpen = true }) {
        ...
        confirmButton = {
            SolosTextButton(onClick = { if (isValid) onSave(buildRule()) }, enabled = isValid) {
