...
import com.solos.app.ui.components.PickerModalityFilter
import com.solos.app.ui.components.modelEntryPickerItems
...
fun AddModelsToGroupScreen(
    ...
    var quickTestEntry by remember { mutableStateOf<com.solos.app.data.model.ModelEntry?>(null) }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    SolosTextButton(onClick = onBack) { Text(stringResource(R.string.common_cancel)) }
                    SolosButton(
                        onClick = {
