...
class PersistentShell(
    ...
    private fun startProcess() {
        ...
        val debugOffload = com.solos.app.BuildConfig.DEBUG
        ...
        // __SOLOS_DONE__ marker detection). Release keeps the original
        ...
        if (debugOffload) env["SOLOS_NOFF_DEBUG"] = "1"
        ...
        env["SOLOS_CHAT_SESSION_ID"] = sessionId
        ...
        try {
            ...
            while (true) {
                ...
                if (cb != null) {
                    ...
                    val markerExitPattern = "__SOLOS_DONE_${cb.marker}_EXIT_"
    ...
    private fun parseExitCode(text: String, marker: String): Int {
        // Pattern: __SOLOS_DONE_{marker}_EXIT_{code}__
        val regex = Regex("__SOLOS_DONE_${Regex.escape(marker)}_EXIT_(\\d+)__")
     ...
     *   {command}; echo "__SOLOS_DONE_{marker}_EXIT_$?__"
     *
    ...
    suspend fun executeCommand(
        ...
        val wrappedCommand = "$command\necho \"__SOLOS_DONE_${marker}_EXIT_\$?__\"\n"
