package com.solos.app.data.model
...
data class ProviderInstance(
     ...
     */
    @Serializable(with = com.solos.app.backup.Iso8601MillisSerializer::class)
    ...
    // an official client (e.g. Claude Code); Solos' default UA gets rejected.
...
data class ModelEntry(
    ...
    @Serializable(with = com.solos.app.backup.Iso8601MillisNullableSerializer::class)
...
data class ProviderConfig(
    ...
    // Models and groups exposed to the agent loop (solos-model-use terminal
