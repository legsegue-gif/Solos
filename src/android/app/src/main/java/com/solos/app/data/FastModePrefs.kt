 ...
 * once at app startup (SolosApp.onCreate) and warms a volatile cache; the
 * context-free [isEnabled] is then safe to call from any request builder.
 */
object FastModePrefs {
    private const val PREFS = "solos_fast_mode_prefs"
    ...
    /** Capture the app context and warm the cache. Called from SolosApp.onCreate. */
