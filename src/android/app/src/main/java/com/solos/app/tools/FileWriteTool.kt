...
object FileWriteTool {
    ...
    fun execute(argsJson: String, sessionId: String, context: Context): ToolExecutionResult {
        return try {
            ...
            // T123: per-session resolver so /var/solos/workspace/...,
            // /var/solos/attachments/..., /var/solos/offloads/...,
            // /var/solos/browser/... land in this session's host dir
            ...
            // /var/solos/workspace/foo/bar.md would otherwise hit "Parent
            ...
            if (path.startsWith("/var/solos/mounts/")) {
