 ...
 *
 * T-html-preview-immersive: now mirrors [com.solos.app.webapp.WebAppActivity]'s
            ...
            AnimatedVisibility(
                ...
                FloatingMenuButton(
                    ...
                    onOpenExternal = {
                        ...
                        com.solos.app.ui.preview.openExternalFromSheet(
...
private fun FloatingMenuButton(
    ...
    Box {
        ...
        com.solos.app.ui.components.SolosMenu(
            ...
            com.solos.app.ui.components.SolosMenuDivider()
            androidx.compose.material3.DropdownMenuItem(
                text = {
