...
object UpdateChecker {
    ...
    private const val OWNER = "Solos"
    // T133: the public repo is Solos/Solos (org + repo share a name).
    // Previously pointed at Solos/SolosApp, which is the private dev
    ...
    // Solos/Solos with a SolosApp-*.apk asset attached.
    private const val REPO = "Solos"
    private const val DOWNLOAD_FILENAME = "solos-update.apk"
    /**
    ...
    const val RELEASES_URL: String = "https://github.com/legsegue-gif/Solos/releases"
    ...
    /**
     * Stream the APK from [url] into `${cacheDir}/shared/solos-update.apk`,
