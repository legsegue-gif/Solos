package com.solos.app.provider.openrouter
...
import com.solos.app.provider.ProviderModelsCache
...
object OpenRouterModelsApi {
    ...
    suspend fun fetchModels(
        ...
        val request = Request.Builder()
            ...
            .header("HTTP-Referer", "https://github.com/legsegue-gif/Solos")
            .header("X-Title", "Solos App")
