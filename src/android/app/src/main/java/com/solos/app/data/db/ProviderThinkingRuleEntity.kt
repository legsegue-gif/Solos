 ...
 * in [com.solos.app.provider.thinking.ThinkingRuleResolver.builtInRules] and are
...
data class ProviderThinkingRuleEntity(
    /** Stable UUID assigned at creation; the drag-reorder target and solos-config handle. */
    ...
    /** Serialized [com.solos.app.provider.thinking.ThinkingWireFormat]; null = "no opinion". */
