package com.solos.app.notification
 ...
 *
 * Trigger contract: this class is hooked into [com.solos.app.service.SessionActivityTracker]
 ...
 *   `solos://session/<sessionId>` (existing
...
class BackgroundTaskNotifier(
    ...
    /**
     * Called by [com.solos.app.service.SessionActivityTracker] when a
     ...
     * [CHANNEL_ID] channel. Called from SolosApp's foreground transition
    ...
    companion object {
        ...
        const val CHANNEL_ID = "solos_task_completed"
    }
}
