package com.solos.app.provider.gemini
...
class GeminiProvider(
    ...
    override suspend fun sendMessageClamped(
        ...
        val request = Request.Builder()
            ...
            // can trace the request back to the Solos build. Gemini has no
    ...
    private fun rawStreamMessage(
        ...
        val request = Request.Builder()
            ...
            // branch above — brand outbound requests with Solos/<version>.
            .applyUserAgentOverride(null)
            .build()
    ...
    private fun buildRequestBody(
        ...
        // [Solos#226] Audio-output models reject systemInstruction with 400
