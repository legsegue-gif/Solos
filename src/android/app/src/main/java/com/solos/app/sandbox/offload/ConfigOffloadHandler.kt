...
import com.solos.app.config.ConfigBridge
...
/**
 * `solos-config` offload handler. Mirrors iOS `ConfigOffload.m`.
 *
...
class ConfigOffloadHandler : NativeOffloadHandler {
    ...
    private fun cmdSet(args: OffloadArgs): NativeOffloadResult {
        ...
        // [T-android-solos-config-set-shell-escape] (issue #36) `--file <path>`
    ...
    /**
     * [T-android-solos-config-set-shell-escape] Read a file's text by its
