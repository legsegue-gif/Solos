...
/**
 * ZIP packaging for `.solosbak`, on both sides of the wire.
 *
...
object BackupZip {
     ...
     * `solosbak-<uuid>/manifest.json` rather than bare `manifest.json`.
     */
     ...
     *
     * After extraction the real package root may be `<dest>/solosbak-<uuid>/`
