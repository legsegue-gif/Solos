...
import com.solos.app.browser.BrowserUseManager
 ...
 * methods operate on the application-scoped [SolosApp.sharedBrowserTabPool]
 * (the same pool the in-shell `solos-browser-use` agent drives) so external
