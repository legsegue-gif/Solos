...
import com.solos.app.ui.chat.InputAttachment
...
internal object ChatMutationMethods {
    ...
    private fun app(context: Context): SolosApp =
     ...
     * [com.solos.app.ui.chat.ChatViewModelStore]) — unlike [prompt], which
    ...
    suspend fun uiPrompt(context: Context, params: JSONObject): JSONObject {
        ...
        val app = app(context)
        val store = com.solos.app.ui.chat.ChatViewModelStore
        ...
        val vm = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.Main) {
            androidx.lifecycle.ViewModelProvider(
                ...
                com.solos.app.ui.chat.ChatViewModel.factory(
                    sessionId = sessionId,
            ...
            )[com.solos.app.ui.chat.ChatViewModel::class.java].also { it.sendMessage(text) }
        }
    ...
    suspend fun status(context: Context, params: JSONObject): JSONObject {
        ...
        return JSONObject().apply {
            ...
            put("isRunning", com.solos.app.service.SessionActivityTracker.isActive(sessionId))
