...
//
// Registered at app startup from SolosApp.onCreate via JNI. Catches
...
#define LOG_TAG "SolosCrashHandler"
...
Java_com_solos_app_crash_NativeCrashHandler_nativeInstall(
